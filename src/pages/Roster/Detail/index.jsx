...
export default ({ selectedDetail, setSelectedDetail }) => {
  if (!selectedDetail || !selectedDetail._id) {
    return <></>;
  }

  const booking = selectedDetail.booking;
  ...
  return (
    <Drawer
      ...
      open={selectedDetail && selectedDetail._id}
      getContainer={false}
      visible={selectedDetail && selectedDetail._id}
    >
      <div className="detail">
        ...
        <div className="detail_single">
          ...
          <div className="detail_single_info">
            ...
            <div className="detail_single_info_value">
              {Moment(selectedDetail.date).format('DD MMM, YYYY')}
            </div>
          </div>
        </div>
        <div className="detail_single">
