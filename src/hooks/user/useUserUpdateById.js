...
const query = `
  UserUpdateById($id: String!, $firstName: String, $lastName: String, $gender: UserGender, $mobile: String, $address: String, $source: UserSource, $hours: Int, $australianBusinessNumber: Int, $taxFileNumber: Int, $idType: UserIdType, $idNumber: Int, $idImage: String, $emergencyContactName: String, $emergencyContactNumber: String, $status: Status) {
